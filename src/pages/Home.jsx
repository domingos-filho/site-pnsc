...
import { ArrowRight, Church, Users, Image as ImageIcon, Calendar, Phone } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Bem-vindo ao site da Paróquia de Nossa Senhora da Conceição em Nova Parnamirim. Conheça nossa comunidade, agenda de eventos, pastorais e muito mais." />
      </Helmet>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
