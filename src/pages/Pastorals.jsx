...
const GroupCard = ({ group }) => (
    <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col h-full hover:shadow-lg transition-shadow duration-300">
        ...
        <p className="text-gray-600 mb-2 flex-grow"><strong className="text-gray-700">Objetivo:</strong> {group.objective}</p>
        <p className="text-gray-600 mb-2"><strong className="text-gray-700">Responsáveis:</strong> {group.responsible}</p>
        <p className="text-gray-600 mb-2"><strong className="text-gray-700">Contato:</strong> {group.howToParticipate}</p>
        <p className="text-gray-600"><strong className="text-gray-700">Reuniões:</strong> {group.meeting}</p>
    </div>
);
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Conheça os grupos, pastorais, movimentos e serviços de nossa paróquia. Participe!" />
            </Helmet>
