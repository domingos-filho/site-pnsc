    ...
    const ManageUsers = () => {
      ...
      const handleSaveUser = (e) => {
        ...
        if (currentUser && currentUser.id) {
          ...
          // Add new user
          if (!password) {
            toast({ title: "Erro!", description: "A senha é obrigatória para novos usuários.", variant: "destructive" });
            return;
          }
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="password">Senha</Label>
                       <div className="relative">
                        ...
                        <Input id="password" name="password" type="password" placeholder={currentUser ? 'Deixe em branco para não alterar' : ''} required={!currentUser} className="pl-10" />
                      </div>
                    </div>
                     <div className="space-y-2">
