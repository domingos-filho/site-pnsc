                ...
                <main className="container mx-auto px-4 py-16">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {communities.map((community, index) => (
                            ...
                            >
                                <Link to={`/comunidades/${community.id}`} className="block bg-white rounded-2xl shadow-md p-8 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 h-full flex flex-col">
                                    ...
                                    <p className="text-gray-600 flex-grow">{community.description.substring(0, 100)}...</p>
